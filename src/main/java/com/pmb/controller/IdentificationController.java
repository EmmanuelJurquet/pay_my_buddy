...
public class IdentificationController {
	...
	public Identification findbyIdentification ( @RequestParam String email, @RequestParam String password) throws ClassNotFoundException, SQLException {
	...
	public Identification identificationByEmail ( @RequestParam String email) throws ClassNotFoundException, SQLException {
		logger.info("Identification Connection");
