...
INSERT INTO Identification (IDN_EMAIL, IDN_PASSWORD) values ('hanna@gmail.com','motdepasse2');
...
INSERT INTO User (USR_FK_IDN, USR_F_NAME, USR_L_NAME, USR_EMAIL, USR_BIRTH, USR_ADDR, USR_PHONE, USR_CITY, USR_ZIP) VALUES ('2','Audrey', 'Guillet','audrey@newmail.com','1984/05/12','10 rue of nowhere', '07-58-55-84','Paris', '75000');
...
CREATE TABLE IdentificationTest (
IDN_ID INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
INSERT INTO IdentificationTest  (IDN_EMAIL, IDN_PASSWORD) values('emmanueljurquet@gmail.com', 'nouveaumotdepasse');
INSERT INTO IdentificationTest (IDN_EMAIL, IDN_PASSWORD) values ('hanna@gmail.com','motdepasse2');
INSERT INTO IdentificationTest (IDN_EMAIL, IDN_PASSWORD) values ('jeannechureau@gmail.com','nouveaumdp3');
...
FOREIGN KEY (USR_FK_IDN) REFERENCES IdentificationTest (IDN_ID));

INSERT INTO UserTest (USR_FK_IDN, USR_F_NAME, USR_L_NAME, USR_EMAIL, USR_BIRTH, USR_ADDR, USR_PHONE, USR_CITY, USR_ZIP) VALUES ('1','Emmanuel',' Jurquet','emmanueljurquet@gmail.com','1979/12/02','10 rue of nowhere',' 07-58-65-98','Paris', '75000');
INSERT INTO UserTest (USR_FK_IDN, USR_F_NAME, USR_L_NAME, USR_EMAIL, USR_BIRTH, USR_ADDR, USR_PHONE, USR_CITY, USR_ZIP) VALUES ('2','Audrey', 'Guillet','audrey@newmail.com','1984/05/12','10 rue of nowhere', '07-58-55-84','Paris', '75000');
INSERT INTO UserTest (USR_FK_IDN, USR_F_NAME, USR_L_NAME, USR_EMAIL, USR_BIRTH, USR_ADDR, USR_PHONE, USR_CITY, USR_ZIP) VALUES ('3','Jeanne','Chureau','jeannechureau@gmail.com','2013/02/07','10 rue de nulle part', '07-65-85-95', 'Paris','75000');
...
FOREIGN KEY (WAL_USR_FK_ID) REFERENCES UserTest ( USR_ID));

INSERT INTO WalletTest (WAL_USR_FK_ID, WAL_BALANCE, WAL_VISA, WAL_EXPIR, WAL_CRYPTO) VALUES ('1', '100.00', '231546598', '10/12', '415');
INSERT INTO WalletTest (WAL_USR_FK_ID, WAL_BALANCE, WAL_VISA, WAL_EXPIR, WAL_CRYPTO) VALUES ('2', '250.00','213556897', '01/06', '416');
INSERT INTO WalletTest (WAL_USR_FK_ID, WAL_BALANCE, WAL_VISA, WAL_EXPIR, WAL_CRYPTO) VALUES ('3', '10.00', '213566456', '05/25', '413');



CREATE TABLE FriendTest (
...
FOREIGN KEY (FR_USR_PROFILE_ID_OWNER) REFERENCES UserTest (USR_ID),

FOREIGN KEY (FR_USR_PROFILE_ID_RECEIVER) REFERENCES UserTest (USR_ID)); 

INSERT INTO FriendTest (FR_USR_PROFILE_ID_OWNER, FR_USR_PROFILE_ID_RECEIVER) values ('1','2');
...
FOREIGN KEY (TRA_USR_PROFILE_ID_EMIT) REFERENCES UserTest (USR_ID),

FOREIGN KEY (TRA_USR_PROFILE_ID_RECEIV) REFERENCES UserTest (USR_ID)); 

INSERT INTO TransactionsTest ( TRA_USR_PROFILE_ID_EMIT, TRA_USR_PROFILE_ID_RECEIV, TRA_DATE ,TRA_AMOUNT, TRA_FEE) values ('1', '2', '2022/10/01', '50.0', '5.0');
